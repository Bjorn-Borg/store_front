...
// EXTERNAL MODULE: ./assets/theme.js
var theme = __webpack_require__("XJy7");
...
// CONCATENATED MODULE: ./components/amp/AmpIncludeCustomElement.js
var __jsx = external_react_default.a.createElement;


/* harmony default export */ var AmpIncludeCustomElement = (props => __jsx(head_default.a, null, __jsx("script", {
  async: true,
  "custom-element": props.name,
  src: "https://cdn.ampproject.org/v0/" + props.name + "-" + props.version + ".js",
  key: props.name
})));
// CONCATENATED MODULE: ./components/amp/AmpAnalytics.js
var AmpAnalytics_jsx = external_react_default.a.createElement;


/* harmony default export */ var AmpAnalytics = (props => AmpAnalytics_jsx(external_react_default.a.Fragment, null, AmpAnalytics_jsx(AmpIncludeCustomElement, {
  name: "amp-analytics",
  version: "0.1"
}), AmpAnalytics_jsx("amp-analytics", {
  type: props.type
}, props.script && AmpAnalytics_jsx("script", {
  type: "application/json",
  dangerouslySetInnerHTML: {
    __html: JSON.stringify(props.script)
  }
}))));
// CONCATENATED MODULE: ./components/amp/AmpOptimize.js
var AmpOptimize_jsx = external_react_default.a.createElement;


/* harmony default export */ var AmpOptimize = (props => AmpOptimize_jsx(external_react_default.a.Fragment, null, AmpOptimize_jsx(AmpIncludeCustomElement, {
  name: "amp-experiment",
  version: "0.1"
}), AmpOptimize_jsx("amp-experiment", null, props.script && AmpOptimize_jsx("script", {
  type: "application/json",
  dangerouslySetInnerHTML: {
    __html: JSON.stringify(props.script)
  }
...
class _document_MyDocument extends document_default.a {
  render() {
    return _document_jsx("html", null, _document_jsx(next_document["Head"], null, _document_jsx("script", {
      async: true,
    ...
    })), _document_jsx("body", null, _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null), _document_jsx(AmpWrap, {
      ampOnly: (_document_jsx(AmpAnalytics, {
        type: "googleanalytics",
        script: {
          vars: {
            account: gtag["a" /* GA_TRACKING_ID */],
            gtag_id: gtag["a" /* GA_TRACKING_ID */],
            config: {
              [gtag["a" /* GA_TRACKING_ID */]]: {
                groups: "default"
              }
            }
          },
      ...
      }), _document_jsx(AmpOptimize, {
        script: experiment
      }))
    }), _document_jsx(AmpWrap, {
      nonAmp: _document_jsx(external_react_default.a.Fragment, null, _document_jsx("script", {
        async: true,
        src: `https://www.googletagmanager.com/gtag/js?id=${gtag["a" /* GA_TRACKING_ID */]}`
      }), _document_jsx("script", {
        dangerouslySetInnerHTML: {
          __html: `
                      ...
                      gtag('config', '${gtag["a" /* GA_TRACKING_ID */]}');
                    `
        }
      }))
    })));
...
_document_MyDocument.getInitialProps = async ctx => {
  ...
  ctx.renderPage = () => originalRenderPage({
    enhanceApp: App => props => sheets.collect(_document_jsx(App, props))
  });
...
const GA_TRACKING_ID = process.env.GOOGLE_ANALYTICS; // https://developers.google.com/analytics/devguides/collection/gtagjs/pages
